        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.menuCard}>
                    ...
                    <View style={styles.divider} />
                    <MenuItem icon="paper-plane-outline" label="Send Notification" onPress={() => navigation.navigate('SendNotification')} />
                </View>
                ...
                <View style={styles.menuCard}>
                    ...
                    <MenuItem
                        icon="layers-outline"
                        label="Master Data"
                        onPress={() => navigation.navigate('PropertyMasterData')}
                    />
                    <View style={styles.divider} />
                    <MenuItem
                ...
                <View style={styles.menuCard}>
                    <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Sidebar')}>
...
const styles = StyleSheet.create({
    ...
    sectionTitle: {
        ...
        paddingHorizontal: spacing.base, marginTop: spacing.md, marginBottom: spacing.xs,
    },
    ...
    avatarText: { fontSize: typography.xxl, fontWeight: typography.bold, color: colors.primary },
    ...
    adminText: { fontSize: typography.xs, fontWeight: typography.bold, color: colors.primary, letterSpacing: 1 },
    menuCard: {
    ...
    menuLabel: { flex: 1, fontSize: typography.base, fontWeight: typography.medium, color: colors.textPrimary },
    badge: {
    ...
    divider: { height: 1, backgroundColor: colors.borderLight, marginLeft: spacing.base + 40 + spacing.md },
    logoutBtn: {
    ...
    logoutText: { fontSize: typography.md, fontWeight: typography.semiBold, color: colors.error },
});
