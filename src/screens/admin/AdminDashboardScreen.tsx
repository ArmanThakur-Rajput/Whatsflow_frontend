    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.85}
        >
          <View style={styles.visitorsIconWrap}>
            <Ionicons name="people" size={26} color="#0891B2" />
          </View>
          <View style={styles.visitorsTextWrap}>
            <Text style={styles.visitorsTitle}>Upcoming Visitors</Text>
            <Text style={styles.visitorsSub}>Today's and upcoming scheduled visitors</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  visitorsTextWrap: { flex: 1 },
  visitorsTitle: {
    fontSize: typography.base, fontWeight: typography.bold, color: '#0E7490',
  },
  visitorsSub: {
    fontSize: typography.xs, color: '#0891B2', marginTop: 2,
  },
});